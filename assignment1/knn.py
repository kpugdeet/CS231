...
for k_val in k_choices:
    ...
    for i in range(num_folds):
        ...
        x_test_cycle =  X_train_folds[i]
        y_test_cycle = y_train_folds[i]
        ...
        # Predict
        y_pred_cycle = knn.predict(x_test_cycle, k_val, 0)
        num_correct = np.sum(y_test_cycle == y_pred_cycle)
        k_to_accuracies[k_val].append(float(num_correct) / float(len(y_pred_cycle)))
################################################################################
#                                 END OF YOUR CODE                             #
################################################################################
